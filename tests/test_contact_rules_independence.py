...
class ContactRuleIndependenceTests(unittest.TestCase):
    def test_short_contacts_require_valid_omission_reference_fail_closed(self):
        ...
        thresholds = {
            ...
            f"{role}.spider_contacts_short_inscribed_rect_width_mm": 1.74,
            f"{role}.spider_contacts_short_inscribed_rect_height_mm": 0.66,
    ...
    def test_long_contacts_require_valid_omission_reference_fail_closed(self):
        ...
        thresholds = {
            ...
            f"{role}.spider_contacts_long_inscribed_rect_width_mm": 0.48,
            f"{role}.spider_contacts_long_inscribed_rect_height_mm": 0.36,
