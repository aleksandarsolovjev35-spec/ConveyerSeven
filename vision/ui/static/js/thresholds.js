...
// переключение мышкой не требует прокрутки ленты; при наведении вкладка
// плавно расширяется и показывает полное название без обрезки. Клик по
// вкладке переключает видимую карточку и разворачивает её (строки в
