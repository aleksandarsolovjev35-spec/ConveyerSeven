...
// и показывает полное название правила; любая другая вкладка раскрывает
// полное название, пока на ней курсор, и сворачивается при уводе. Клик
// по вкладке переключает видимую карточку и разворачивает её (строки в
// полный рост); повторный клик по активной вкладке сворачивает карточку
...
function renderThresholdsBody() {
    ...
    // (остальные — пока на них курсор), лента прокручивается по
    // горизонтали.
