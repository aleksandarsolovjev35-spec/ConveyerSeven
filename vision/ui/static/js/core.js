...
const state = {
    ...
    nudgeHoldPending:     false,
    nudgeHoldConfirmed:   false,
    nudgeHoldReleasePending: false,
    nudgeHoldStartPromise: null,
    nudgeHeartbeatTimer:  null,
    nudgeHeartbeatBusy:   false,
    nudgeHoldBusy:        false,
    nudgeOffset:          0,
    nudgeLimitSteps:      0,
...
const els = {
    ...
    btnStop:          $('btn-stop'),
    btnExit:          $('btn-exit'),
    nudgePanel:       $('nudge-panel'),
    nudgeForward:     $('nudge-forward'),
    nudgeBackward:    $('nudge-backward'),
    nudgeOffset:      $('nudge-offset'),
    nudgeLimit:       $('nudge-limit'),
    nudgeBarFill:     $('nudge-bar-fill'),
