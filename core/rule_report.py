...
METRIC_PARAM_LABELS = {
    ...
    # Геометрия входного окна — как в примере ТЗ
    ("window_geometry", "top_px_min"): "Верх зоны окон: мин. px",
    ("window_geometry", "top_px_max"): "Верх зоны окон: макс. px",
    ("window_geometry", "bottom_px_min"): "Низ зоны окон: мин. px",
    ("window_geometry", "bottom_px_max"): "Низ зоны окон: макс. px",
}
